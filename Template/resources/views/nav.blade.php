<nav class="navbar navbar-inverse">
  <div class="container">
    ...
    @if (Auth::guest())
      <a class="navbar-brand" href="/pfsahid">
    ...
    @elseif(Auth::user()->level=="petugas")
      <a class="navbar-brand" href="/pfsahid">
        <span class="glyphicon glyphicon-th" aria-hidden="true"></span>  
        <font color="blue">Petugas</font></a>
         </div>
      ...
      <ul class="nav navbar-nav">
        <li><a href="/games">Games<span class="sr-only"></span></a></li>
      </ul>
   ...
   <a class="navbar-brand" href="/pfsahid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav">
        <li><a href="/kategories/">Kategori<span class="sr-only"></span></a></li>
      </ul>
      <ul class="nav navbar-nav">
        <li><a href="/games">Games<span class="sr-only"></span></a></li>
      </ul>
      ...
      <a class="navbar-brand" href="/pfsahid">
        <span class="glyphicon glyphicon-th" aria-hidden="true"></span>  
        <font color="blue">Konsumen</font></a>
    </div>
    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="/konsumen">Petugas<span class="sr-only"></span></a></li>
      </ul>
      <ul class="nav navbar-nav">
        <li><a href="/daftargame">List Games<span class="sr-only"></span></a></li>
      </ul>
      <ul class="nav navbar-nav">
        <li><a href="/pesan">Form Pemesanan<span class="sr-only"></span></a></li>
      </ul>
